...
if ss==1
    ...
    plot(weights, energyMed25,'o','LineWidth',4)
  
    yyaxis right
    ax.YAxis(2).FontSize = 16;
    plot(weights, speedMed25,'d','LineWidth',4)
...
elseif ss==2
    ...
    axis([0 0.25 3 4]);
    ylabel('Median Energy Consumption (nJ)');
    plot(charges, energyMed10,'o','LineWidth',4)
  
    yyaxis right
    axis([0 0.25 70 90]);
    ax.YAxis(2).FontSize = 16;
    plot(charges, speedMed10,'d','LineWidth',4)
    ylabel('Median Convergence Time (ns)');
